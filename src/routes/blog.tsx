  ...
  return (
    <main className="min-h-screen pb-24 pt-32">
      <div className="mx-auto max-w-5xl px-6">
        ...
        >
          Deep reads, cultural guides, and hard-won travel wisdom from our editorial team and community.
        </motion.p>
              ...
              >
                  ...
                  <div className="grid sm:grid-cols-[280px_1fr]">
                    ...
                    <div className="p-6">
                      <div className="flex items-center gap-3 text-xs text-muted-foreground">
                        <span className="rounded-full bg-gold/15 px-2.5 py-1 text-gold font-medium">
                          {article.category}
                        </span>
                ...
                <AnimatePresence>
                  {expanded === article.id && (
                    ...
                    >
                      <div className="prose prose-invert prose-sm max-w-none border-t border-white/10 px-6 py-6">
                        {article.body.split("\n\n").map((paragraph, pi) => (
                          <p
                            key={pi}
                            className="mb-4 text-sm leading-relaxed text-foreground/85"
