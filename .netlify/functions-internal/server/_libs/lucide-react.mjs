...
const CloudSun = createLucideIcon("cloud-sun", __iconNode$E);
const __iconNode$D = [
...
const Landmark = createLucideIcon("landmark", __iconNode$u);
const __iconNode$t = [
...
const Ticket = createLucideIcon("ticket", __iconNode$7);
const __iconNode$6 = [
