import { G as Group, f as Vector2, V as Vector3, M as Mesh, E as Euler, S as SphereGeometry, c as MeshLambertMaterial, D as DoubleSide, L as Line, g as LineBasicMaterial, h as Color, P as Points, B as BufferGeometry, i as PointsMaterial, j as Line2, k as LineGeometry, l as LineMaterial, m as ShaderMaterial, N as NormalBlending, n as CircleGeometry, a as MeshBasicMaterial, o as LineSegments, O as Object3D, p as TubeGeometry, q as CubicBezierCurve3, r as Curve, s as CylinderGeometry, b as Matrix4, T as TextureLoader, d as SRGBColorSpace, t as MeshPhongMaterial, u as CSS2DObject, v as TextGeometry, w as BoxGeometry, x as Font, y as BufferAttribute, z as ShaderChunk, _ as _bfg, A as BackSide, H as StorageInstancedBufferAttribute, W as WebGPURenderer, I as Fn, J as If, K as uniform, Q as storage, R as float, U as instanceIndex, X as Loop, Y as sqrt, C as Camera, Z as cos, $ as asin, a0 as exp, a1 as negate, a2 as sin } from "./three.mjs";
import { i as index } from "./kapsule.mjs";
import { G as Group$1, T as Tween, E as Easing } from "./tweenjs__tween.js.mjs";
import { T as ThreeSlippyMapGlobe } from "./three-slippy-map-globe.mjs";
import { G as GeoJsonGeometry } from "./three-geojson-geometry.mjs";
import { i as index$1 } from "./accessor-fn.mjs";
import { t as tinycolor } from "./tinycolor2.mjs";
import { D as DataBindMapper } from "./data-bind-mapper.mjs";
import { _ as _FrameTicker } from "./frame-ticker.mjs";
import { C as ConicPolygonGeometry } from "./three-conic-polygon-geometry.mjs";
import { i as index$2 } from "./index-array-by.mjs";
import { p as polygonToCells, c as cellToLatLng, a as cellToBoundary, l as latLngToCell } from "./h3-js.mjs";
import { l as linear, q as quantize } from "./d3-scale.mjs";
import { f as max, s as sum } from "./d3-array.mjs";
import { g as geoDistance$1, a as geoInterpolate, h as graticule10 } from "./d3-geo.mjs";
import { c as color } from "./d3-color.mjs";
import { c as interpolateArray } from "./d3-interpolate.mjs";
import { i as interpolateTurbo } from "./d3-scale-chromatic.mjs";
...
var GlobeLayerKapsule = index({
  props: {
    ...
    globeTileEngineUrl: {
      onChange: function onChange4(v, state) {
        state.tileEngine.tileUrl = v;
      }
    },
    globeTileEngineMaxLevel: {
      "default": 17,
      onChange: function onChange5(v, state) {
        state.tileEngine.maxLevel = v;
      },
      triggerUpdate: false
    },
    updatePov: {
      onChange: function onChange6(v, state) {
    ...
    if (changedProps.hasOwnProperty("globeImageUrl")) {
      if (!state.globeImageUrl) {
        ...
        new THREE$h.TextureLoader().load(state.globeImageUrl, function(texture) {
          ...
          (_globeMaterial$map = globeMaterial2.map) === null || _globeMaterial$map === void 0 || _globeMaterial$map.dispose();
    ...
    if (changedProps.hasOwnProperty("bumpImageUrl")) {
      if (!state.bumpImageUrl) {
        ...
        state.bumpImageUrl && new THREE$h.TextureLoader().load(state.bumpImageUrl, function(texture) {
          ...
          (_globeMaterial$bumpMa = globeMaterial2.bumpMap) === null || _globeMaterial$bumpMa === void 0 || _globeMaterial$bumpMa.dispose();
...
var setExtendedMaterialUniforms = function setExtendedMaterialUniforms2(material) {
  var uniformsFn = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : function(u) {
    return u;
  };
  ...
  update: function update3(state) {
    ...
    function calcCurve(_ref4) {
      ...
      var getVec = function getVec2(_ref5) {
        var _ref6 = _slicedToArray(_ref5, 3), lng = _ref6[0], lat = _ref6[1], alt2 = _ref6[2];
...
var computeGeoKde = /* @__PURE__ */ (function() {
  var _ref4 = _asyncToGenerator(/* @__PURE__ */ _regenerator().m(function _callee(vertexGeoCoords) {
    var _navigator;
    var data, _ref5, _ref5$lngAccessor, lngAccessor, _ref5$latAccessor, latAccessor, _ref5$weightAccessor, weightAccessor, bandwidth, BW_RADIUS_INFLUENCE, Fn$1, If$1, uniform$1, storage$1, _float, instanceIndex$1, Loop$1, sqrt$1, sin$1, cos$1, asin$1, exp$1, negate$1, sCoords, sData, res, sRes, PI, sqrt2PI2, sq3, hav, geoDistance2, gaussianKernel2, bwRad, maxRRad, n, computeShaderFn, computeNode, renderer, _args = arguments, _t, _t2, _t3;
    return _regenerator().w(function(_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          sData = storage$1(new StorageInstancedBufferAttribute(new Float32Array(data.map(function(d) {
          ...
          sRes = storage$1(res, "float", vertexGeoCoords.length);
          PI = _float(Math.PI);
          sqrt2PI2 = sqrt$1(PI.mul(2));
          sq3 = function sq4(x) {
            return x.mul(x);
          };
          hav = function hav2(x) {
            return sq3(sin$1(x.div(2)));
          };
          geoDistance2 = function geoDistance3(a, b) {
            ...
            var lngA = _float(a[0]);
            var lngB = _float(b[0]);
            return _float(2).mul(asin$1(sqrt$1(hav(latB.sub(latA)).add(cos$1(latA).mul(cos$1(latB)).mul(hav(lngB.sub(lngA)))))));
          };
          gaussianKernel2 = function gaussianKernel3(x, bw) {
            return exp$1(negate$1(sq3(x.div(bw)).div(2))).div(bw.mul(sqrt2PI2));
          };
          bwRad = uniform$1(toRad(bandwidth));
          maxRRad = uniform$1(toRad(bandwidth * BW_RADIUS_INFLUENCE));
          n = uniform$1(data.length);
          computeShaderFn = Fn$1(function() {
            var coords = sCoords.element(instanceIndex$1);
            var res2 = sRes.element(instanceIndex$1);
            res2.assign(0);
            Loop$1(n, function(_ref6) {
              var i = _ref6.i;
              var d = sData.element(i);
              var weight = d.z;
              If$1(weight, function() {
                var dist = geoDistance2(d.xy, coords.xy);
                If$1(dist && dist.lessThan(maxRRad), function() {
    ...
    state.dataMapper.onUpdateObj(function(obj, d) {
      ...
      computeGeoKde(vertexGeoCoords, pnts, {
        ...
        var applyUpdate = function applyUpdate2(td) {
          ...
          obj.geometry.setAttribute("color", array2BufferAttr(kdeVals2.map(function(v) {
  ...
  update: function update6(state) {
    ...
    state.dataMapper.onUpdateObj(function(obj, _ref2) {
      ...
      [[!sideMaterial && sideColor, sideIdx], [!capMaterial && capColor, capIdx]].forEach(function(_ref3) {
        var _ref4 = _slicedToArray(_ref3, 2), color2 = _ref4[0], materialIdx = _ref4[1];
        ...
        var applyUpdate = function applyUpdate2(td) {
          ...
          obj.geometry = !hexBins.length ? new THREE$a.BufferGeometry() : (BufferGeometryUtils.mergeGeometries || BufferGeometryUtils.mergeBufferGeometries)(hexBins.map(function(h) {
            ...
            if (useDots) {
              ...
              var edgePos = polar2Cartesian(h.hexGeoJson[0][1], h.hexGeoJson[0][0], alt2);
...
var ParticlesLayerKapsule = index({
  ...
  init: function init10(threeObj, state) {
    ...
    state.dataMapper = new ThreeDigest(threeObj, {
      ...
      var particlesListAccessor = index$1(state.particlesList);
      var latAccessor = index$1(state.particleLat);
      var lngAccessor = index$1(state.particleLng);
      var altitudeAccessor = index$1(state.particleAltitude);
  ...
  update: function update10(state, changedProps) {
    ...
    var colorAccessor = index$1(state.particlesColor);
    var sizeAccessor = index$1(state.particlesSize);
    var sizeAttenuationAccessor = index$1(state.particlesSizeAttenuation);
    var textureAccessor = index$1(state.particlesTexture);
...
var LabelsLayerKapsule = index({
  ...
  update: function update12(state) {
    ...
    state.dataMapper.onUpdateObj(function(obj, d) {
      ...
      bbObj.geometry = _construct(THREE$3.BoxGeometry, _toConsumableArray(new THREE$3.Vector3().subVectors(textObj.geometry.boundingBox.max, textObj.geometry.boundingBox.min).clampScalar(0, Infinity).toArray()));
...
var Globe = index({
  ...
  methods: _objectSpread2({
    ...
    setPointOfView: function setPointOfView(state, camera) {
      var globalPov = camera instanceof THREE.Camera ? camera.position : camera;
...
function fromKapsule(kapsule) {
  ...
  var Globe2 = /* @__PURE__ */ (function(_baseClass) {
    function Globe3() {
      var _this;
      _classCallCheck(this, Globe3);
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      _this = _callSuper(this, Globe3, [].concat(args));
      _this.__kapsuleInstance = _construct(kapsule, [].concat(_toConsumableArray(initKapsuleWithSelf ? [_this] : []), args));
      return _this;
    }
    _inherits(Globe3, _baseClass);
    return _createClass(Globe3);
  })(baseClass);
