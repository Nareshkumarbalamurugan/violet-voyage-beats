import { C as Camera, V as Vector3, G as Group, M as Mesh, S as SphereGeometry, a as MeshBasicMaterial, F as Frustum, b as Matrix4, c as MeshLambertMaterial, T as TextureLoader, d as SRGBColorSpace } from "./three.mjs";
import { o as octree } from "./d3-octree.mjs";
import { l as linear } from "./d3-scale.mjs";
import { m as mercatorRaw } from "./d3-geo.mjs";
...
var ThreeSlippyMapGlobe = /* @__PURE__ */ (function(_Group) {
  function ThreeSlippyMapGlobe2(radius) {
    ...
    _classCallCheck(this, ThreeSlippyMapGlobe2);
  ...
  return _createClass(ThreeSlippyMapGlobe2, [{
    key: "tileUrl",
    get: (
      // Public attributes
      function get() {
      ...
      _classPrivateFieldSet2(_isInView, this, function(d) {
        if (!d.hullPnts) {
          ...
          d.hullPnts = [[lat, lng], [lat0, lng0], [lat1, lng0], [lat0, lng1], [lat1, lng1]].map(function(_ref2) {
            var _ref3 = _slicedToArray(_ref2, 2), lat2 = _ref3[0], lng2 = _ref3[1];
...
function _fetchNeededTiles() {
  ...
  tiles.filter(function(d) {
    ...
    if (!d.loading) {
      d.loading = true;
      new TextureLoader().load(_this5.tileUrl(x2, y2, _this5.level), function(texture) {
        var tile2 = d.obj;
        if (tile2) {
          texture.colorSpace = SRGBColorSpace;
          tile2.material.map = texture;
